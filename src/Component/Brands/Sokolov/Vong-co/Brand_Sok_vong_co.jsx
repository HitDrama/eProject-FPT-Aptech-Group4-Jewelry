...
import Vong_co_Sok from '../../../json/sokolov/daychuyen.json'
import Sp from './Sp'
import { Link } from 'react-router-dom'

function Brand_Sok_vong_co({ addCourseToCartFunction }) {
    return (
        <div>
...
export default Brand_Sok_vong_co