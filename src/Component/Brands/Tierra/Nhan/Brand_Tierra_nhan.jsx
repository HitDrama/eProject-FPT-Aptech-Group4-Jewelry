...
import Nhan_Tierra from '../../../json/tierra/nhan.json'
import Sp from './Sp'
import { Link } from 'react-router-dom'

function Brand_Tierra_nhan({ addCourseToCartFunction }) {
    return (
        <div>
...
export default Brand_Tierra_nhan