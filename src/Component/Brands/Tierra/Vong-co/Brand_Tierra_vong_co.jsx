...
import Vong_co_Tierra from '../../../json/tierra/daychuyen.json'
import Sp from './Sp'

function Brand_Tierra_vong_co() {
    return (
        <div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            <ol class="breadcrumb justify-content-md-end">
                                ...
                                <li class="breadcrumb-item active">Glamira</li>
...
export default Brand_Tierra_vong_co