                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src='assets/anhsanpham/Sokolov/Nhan/nhan4.jpg' data-zoom-image="assets/images/product_zoom_img1.jpg" alt="product_img1" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Swarovski White Gold Ring</a></h4>
                                    <div className="product_price">
                                        <span className="price">$456,44</span>
                                        <del>$478,00</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>Swarovski marble is produced by the Swarovski stone factory. The optical properties of this stone are almost the same as diamond. Each way of attachment of the ring is solved with special laziness to increase the durability of the product
                                        </p>
                                    </div>
