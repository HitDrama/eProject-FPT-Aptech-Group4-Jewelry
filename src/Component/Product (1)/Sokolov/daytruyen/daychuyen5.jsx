                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src="assets/anhsanpham/Sokolov/daychuyen/daychuyen5.jpg" alt="assets/anhsanpham/Pandora/daychuyen/daychuyen1.jpg" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">585 Gold Pendant</a></h4>
                                    <div className="product_price">
                                        <span className="price">$695,37</span>
                                        <del>$725,00</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>A precious rosebud presented in gold and decorated with shining rhinestones will decorate your formal and evening looks. The rich colors, brilliance of precious metals and the shine of impeccable stones can complete the chosen outfit, regardless of its cut and color.
                                        </p>
                                    </div>
