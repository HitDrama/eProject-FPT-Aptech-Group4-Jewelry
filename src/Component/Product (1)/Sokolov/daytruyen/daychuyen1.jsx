                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src="assets/anhsanpham/Sokolov/daychuyen/daychuyen1.jpg" alt="assets/anhsanpham/Pandora/daychuyen/daychuyen1.jpg" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Angel Pendant
                                    </a></h4>
                                    <div className="product_price">
                                        <span className="price">$864,26</span>
                                        <del>$980,00</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>The combination of deep motifs like being lost in space is interwoven with gold wreaths to enhance the art of the design. In the middle of the pendant, a moving diamond is added, making the product stand out special.</p>
                                    </div>
