                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src="assets/anhsanpham/Pandora/nhan/nhan6.jpg" alt="assets/anhsanpham/Pandora/daychuyen/daychuyen1.jpg" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Diamond Ring Accablement</a></h4>
                                    ...
                                    <div className="product_sort_info">
                                        <ul>
                                            <li><i className="linearicons-shield-check"></i> 1 Years  Brand Warranty</li>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>Since its inception, the GLAMIRA jewelry brand has always strived to perfect each special and emotional moment of its users, based on quality and trust. Believing that everyone is special and unique, GLAMIRA produces designs that offer freedom of personalization.</p>
                                    </div>
