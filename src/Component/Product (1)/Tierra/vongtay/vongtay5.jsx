                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src='assets/anhsanpham/Tierra/vongtay/vongtay5.jpg' data-zoom-image="assets/images/product_zoom_img1.jpg" alt="product_img1" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Custom Design bracelet VTA8104</a></h4>
                                    <div className="product_price">
                                        <span className="price">$11104,81</span>
                                        <del>$55.25</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>Custom Design VTA8104 bracelet is a suitable bracelet for girls pursuing a luxurious and individual style. The women's bracelet is designed to look like a chain made of many small sparkling diamonds.</p>
                                    </div>
