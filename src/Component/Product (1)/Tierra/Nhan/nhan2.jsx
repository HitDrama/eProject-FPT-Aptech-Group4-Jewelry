                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Eternity Flat Cut NCF0016</a></h4>
                                    <div className="product_price">
                                        <span className="price">$822,25</span>
                                        <del>$55.25</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>Eternity Flat Cut NCF0016 women's wedding ring is a simple but unique style women's wedding ring with a classNameic, sophisticated Eternity design combined with a sophisticated flat cut design encrusted with small diamonds arranged alternately. Together with meticulousness, it creates a highlight and makes the appearance of this Eternity ring more eye-catching and feminine.</p>
                                    </div>
