                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src='assets/anhsanpham/Tierra/nhan/nhan1.jpg' data-zoom-image="assets/images/product_zoom_img1.jpg" alt="product_img1" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Eternity Princess Wedding Rings</a></h4>
                                    <div className="product_price">
                                        <span className="price">$1150,16</span>
                                        <del>$55.25</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>NCF0003 women's wedding ring is an Eternity women's ring model with a simple but feminine and luxurious design. The ring has a slim design that helps accentuate women's small hands. A strip of sheet stones is attached along the ring band to increase sparkle
                                        </p>
                                    </div>
