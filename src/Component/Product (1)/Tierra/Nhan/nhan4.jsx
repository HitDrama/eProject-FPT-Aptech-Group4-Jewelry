                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src='assets/anhsanpham/Tierra/nhan/nhan4.jpg' data-zoom-image="assets/images/product_zoom_img1.jpg" alt="product_img1" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Ring Eternity NCF0022</a></h4>
                                    <div className="product_price">
                                        <span className="price">$1259,73</span>
                                        <del>$55.25</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>Originating in ancient Egypt, the Eternity diamond wedding ring consists of small stones attached together to form a circle, representing eternal, indestructible love. With this profound meaning, Eternity diamond rings are always the top choice for couples looking for a 100-year-old keepsake.</p>
                                    </div>
