                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src='assets/anhsanpham/Tierra/nhan/nhan5.jpg' data-zoom-image="assets/images/product_zoom_img1.jpg" alt="product_img1" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Geometric Eternity Ring NCF0024</a></h4>
                                    <div className="product_price">
                                        <span className="price">$1109,79</span>
                                        <del>$55.25</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p> Bringing perfect and sophisticated beauty, the NCF0024 women's wedding ring is uniquely designed with a sophisticated bezel prong and a small sparkling diamond firmly placed in a delicate diamond-shaped frame, combined with a diamond groove. The panels are meticulously attached, creating a beautiful and luxurious appearance that attracts all girls' eyes from the first time.
                                            trọng lượng: 2.46 gam</p>
                                    </div>
