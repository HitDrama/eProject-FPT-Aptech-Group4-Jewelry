                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src='assets/anhsanpham/Tierra/nhan/nhan3.jpg' data-zoom-image="assets/images/product_zoom_img1.jpg" alt="product_img1" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Ring Eternity NCF0018</a></h4>
                                    <div className="product_price">
                                        <span className="price">$809,48</span>
                                        <del>$55.25</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>Eternity diamond wedding rings are loved for their luxurious beauty and profound meaning of faithful love. Eternity wedding rings appeared as early as around 2000-1800 BC, when the ancient Egyptians wanted to create an "eternal circle" so they attached small diamonds consecutively, sharing the same starting point. and endpoint</p>
                                    </div>
