                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src="assets/anhsanpham/Tierra/daychuyen/daychuyen4.jpg" alt="assets/anhsanpham/Pandora/daychuyen/daychuyen1.jpg" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Custom Halo Pendant</a></h4>
                                    <div className="product_price">
                                        <span className="price">$1052,57</span>
                                        <del>$55.25</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>With the message Every woman is a brilliant flower, Tierra brings a collection of mesh pendants with the main design being jade flowers and amethyst, of which the Custom Halo MDA2117 women's sword pendant becomes famous. turned on by his beautiful cruelty</p>
                                    </div>
