                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src="assets/anhsanpham/Tierra/daychuyen/daychuyen3.jpg" alt="assets/anhsanpham/Pandora/daychuyen/daychuyen1.jpg" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Cushion Halo Pendant</a></h4>
                                    <div className="product_price">
                                        <span className="price">$834,77</span>
                                        <del>$55.25</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>Unique and feminine is what the Cushion Halo MDA2107 women's pendant brings to the wearer. New design with Cushion master, this is a square diamond shape with rounded corners creating softness and femininity for the jewelry.</p>
                                    </div>
