                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src="assets/anhsanpham/Tierra/daychuyen/daychuyen5.jpg" alt="assets/anhsanpham/Pandora/daychuyen/daychuyen1.jpg" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Heart-Shaped Reverse Pendant</a></h4>
                                    <div className="product_price">
                                        <span className="price">$822,51</span>
                                        <del>$55.25</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>The Heart-shape Reverse MDA3103 women's chain pendant stands out with a unique romantic beauty that is difficult to bring to any other jewelry. The heart body in jewelry has always maintained its appeal because this is considered a symbol of love.</p>
                                    </div>
