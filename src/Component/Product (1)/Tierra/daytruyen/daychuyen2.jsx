                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src="assets/anhsanpham/Tierra/daychuyen/daychuyen2.jpg" alt="assets/anhsanpham/Pandora/daychuyen/daychuyen1.jpg" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Halo Floral Pendant</a></h4>
                                    <div className="product_price">
                                        <span className="price">$951,37</span>
                                        <del>$55.25</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>Like other classNameic Halo designs, the Halo Floral MDA2104 pendant brings elegance, nobility and shines brightly from every angle. The pendant stands out with a large round diamond fixed on 6 prongs combined with a Halo ring of sheet stones attached into flower petals that completely hug the main diamond.</p>
                                    </div>
