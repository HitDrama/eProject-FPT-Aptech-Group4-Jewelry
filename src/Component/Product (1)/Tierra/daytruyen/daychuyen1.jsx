                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src="assets/anhsanpham/Tierra/daychuyen/daychuyen1.jpg" alt="assets/anhsanpham/Pandora/daychuyen/daychuyen1.jpg" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Single Halo Pendant
                                    </a></h4>
                                    <div className="product_price">
                                        <span className="price">$625,73 </span>
                                        <del>$670,00</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>Luxurious, elegant and brilliant are the words that describe the beauty of the Single Halo MDA2102 Diamond Pendant. With a prominent large diamond design in the center attached to 4 spokes, it creates a feeling of safety and security.</p>
                                    </div>
