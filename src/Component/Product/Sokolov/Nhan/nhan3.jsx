                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src='assets/anhsanpham/Sokolov/Nhan/nhan3.jpg' data-zoom-image="assets/images/product_zoom_img1.jpg" alt="product_img1" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Gold Ring with Cz Stone</a></h4>
                                    <div className="product_price">
                                        <span className="price">$192,79</span>
                                        <del>$218,00</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>Gentle and pristine, the delicately attached CZ stones will cherish and hug her delicate fingers, creating a feeling of elegance and luxury. CZ stones were also used by Sokolov to add sparkle to the gold ring. Wearing this design, she will be like a proud and seductive princess stepping out into a magnificent, majestic and shining party.
                                        </p>
                                    </div>
