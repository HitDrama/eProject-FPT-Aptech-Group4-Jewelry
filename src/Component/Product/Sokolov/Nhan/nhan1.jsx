                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src='assets/anhsanpham/Sokolov/Nhan/nhan1.jpg' data-zoom-image="assets/images/product_zoom_img1.jpg" alt="product_img1" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Rose Gold Ring with Diamonds</a></h4>
                                    <div className="product_price">
                                        <span className="price">$702,78</span>
                                        <del>$785,00</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>The sophistication of rose petals covered with gold and shining brightly thanks to the hands of experienced jewelers of SOKOLOV. This jewelry will be a sophisticated addition to your favorite dress and your natural charm.</p>
                                    </div>
