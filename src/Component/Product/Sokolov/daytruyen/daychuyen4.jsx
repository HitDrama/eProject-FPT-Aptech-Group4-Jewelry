                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <div className="product-image">
                                <div className="product_img_box">
                                    <img id="product_img" src="assets/anhsanpham/Sokolov/daychuyen/daychuyen4.jpg" alt="assets/anhsanpham/Pandora/daychuyen/daychuyen1.jpg" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="pr_detail">
                                <div className="product_description">
                                    <h4 className="product_title"><a href="#">Pendant with Diamonds</a></h4>
                                    <div className="product_price">
                                        <span className="price">$463,03</span>
                                        <del>$480,00</del>
                            ...
                            <div className="tab-style3">
                                ...
                                <div className="tab-content shop_info_tab">
                                    <div className="tab-pane fade show active" id="Description" role="tabpanel" aria-labelledby="Description-tab">
                                        <p>Gold pendant with delicate, intricate lines studded with moving diamonds. Such a special way of attaching stones makes the pendant more vivid, attracting the eyes of the opposite person.
                                        </p>
                                    </div>
